...
defaultPreset.theme.colors = {
  ...
  'success-stroke': 'rgb(var(--color-success-stroke) / <alpha-value>)',
  ...
  'danger-stroke': 'rgb(var(--color-danger-stroke) / <alpha-value>)',
  ...
  'warning-stroke': 'rgb(var(--color-warning-stroke) / <alpha-value>)',
  'info-light': 'rgb(var(--color-info-light) / <alpha-value>)',
  info: 'rgb(var(--color-info) / <alpha-value>)',
  'info-dark': 'rgb(var(--color-info-dark) / <alpha-value>)',
  'info-stroke': 'rgb(var(--color-info-stroke) / <alpha-value>)',
