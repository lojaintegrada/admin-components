    ...
    <div className="sidebar z-1 w-0 " id="sidebar-menu">
      <a className="sidebar-mode-toggle hidden lg:flex" href="javascript:;">
        ...
        >
          <path
            fill-rule="evenodd"
            d="M10.75 14a.995.995 0 01-.665-.253l-4.5-4a1.001 1.001 0 010-1.495l4.5-4a1 1 0 111.329 1.495L7.757 9l3.659 3.252A1 1 0 0110.75 14z"
            clip-rule="evenodd"
          ></path>
        </svg>
      </a>
        ...
        <div className="sidebar-item ">
          ...
          >
            ...
            <span className="sidebar-item-full">
              Vendas
              <svg
                className="fill-current sidebar-item-arrow"
                viewBox="0 0 18 18"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path
          ...
          <div
            className="sidebar-item-dropdown hidden"
            id="sidebar-item-dropdown-vendas"
          >
            <a
              className=""
              href="//app-qa1.devqa.lojaintegrada.com.br/painel/pedido/listar"
              id="cat-item-pedidos"
            >
              Pedidos
            </a>
            <a
              className=""
              href="//app-qa1.devqa.lojaintegrada.com.br/painel/cliente/listar"
              id="cat-item-clientes"
            >
              Clientes
            </a>
            <a
              href="http://dashboard.awsli.com.br/index.html?source=1e5998f00d9143a12e69fa8a12aea82a"
              target="_blank"
              id="cat-item-diario-bordo"
            >
              Diário de Bordo
            </a>
            <a
              className=""
              href="//app-qa1.devqa.lojaintegrada.com.br/painel/relatorio/"
              id="cat-item-relatorios"
            >
              Relatórios
            </a>
          </div>
