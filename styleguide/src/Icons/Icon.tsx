...
export const Icon: FunctionComponent<IconProps> = ({ icon, block = false, size = 5, className }: IconProps) => {
  ...
  return (
    <svg className={classes} viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <Path />
    </svg>
  );
};
